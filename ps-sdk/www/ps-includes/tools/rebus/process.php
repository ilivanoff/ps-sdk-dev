 ...
 * Рядом с классом PsMathRebus лежит файл с ребусами и ответами на них: ps-inclides/.../rebuses.txt
 * Процесс берёт файл rebuses.txt с ребусами и обрабатывает его, учитывая, какие ребусы уже были обработаны.
 * По факту обработки строится файл с ответами и копируется на место ps-inclides/.../rebuses.txt
 */
